...
namespace MvcMovie.Controllers
{
    public class DaiLyController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MaDaiLy,TenDaiLy,DiaChi,NguoiDaiDien,DienThoai,ma_HTPP,Id,MaHTPP,TenHTPP")] DaiLy daiLy)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MaDaiLy,TenDaiLy,DiaChi,NguoiDaiDien,DienThoai,ma_HTPP,Id,MaHTPP,TenHTPP")] DaiLy daiLy)
        {
            if (id != daiLy.Id)
            {
                return NotFound();
